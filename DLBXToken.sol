 ...
 *
 * This is the proposed token contract for the DealBox token. It utilizes Majoolr's
 * TokenLib library to reduce custom source code surface area and increase overall
 * security. The TokenLib library has been tested and deployed to three Ethereum
 * networks including mainnet at address 0x0aa4e6e25a76f81f079aa300c33621e20c632e6a
 * and can be verified at etherscan.io. A copy of the TokenLib library has been
 * pasted at the bottom of this contract for convenience.
 *
...
contract DLBXToken {
  ...
  function TokenLibTestContract(address owner, //To be determined
                                string name, //DealBox
                                string symbol, //DLBX
                                uint8 decimals, //0
